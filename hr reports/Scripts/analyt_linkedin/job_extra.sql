...
,match(lower(title),'(organisch)|(fec )|(risk)|(management)|(logistic)|(science)|(compliance )|(geo)|(dutch)|(cdd)|(biolog)|(marketeer)|(security)|(business)|(bio)|(soc\ )') minus_keyword_detected
