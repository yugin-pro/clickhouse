...
create or replace table extracted.linkedin_20240317 ENGINE = MergeTree ORDER by id_chunk_stored as
...
from raw_firebase.decodeurl_51e7f_default_rtdb_linkedin_20240317
) array
join ess
)
) array
